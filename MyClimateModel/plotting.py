...
def get_surface_change_plot_as_bytes():
    # Read in the raw temperature and emissions datasets (they are in CSV format) 
    raw_t = pd.read_csv('./data/Temp.csv', skiprows=1)
...
def get_global_carbon_dioxide_change_plot_as_bytes():
    ...
    # Enable grid
    ax.grid()
    bytes_image_world = io.BytesIO()
    plt.savefig(bytes_image_world, format='png')
    bytes_image_world.seek(0)
    return bytes_image_world
...
def get_usa_carbon_dioxide_change_plot_as_bytes():
    raw_e = pd.read_csv('./data/API_EN.ATM.CO2E.PC_DS2_en_csv_v2_713061.csv', skiprows=3)
    ...
    # Enable grid
    ax.grid()
    bytes_image_usa = io.BytesIO()
    plt.savefig(bytes_image_usa, format='png')
    bytes_image_usa.seek(0)
    return bytes_image_usa
...
def get_china_carbon_dioxide_change_plot_as_bytes():
    raw_e = pd.read_csv('./data/API_EN.ATM.CO2E.PC_DS2_en_csv_v2_713061.csv', skiprows=3)
    ...
    # Enable grid
    ax.grid()
    bytes_image_china = io.BytesIO()
    plt.savefig(bytes_image_china, format='png')
    bytes_image_china.seek(0)
    return bytes_image_china
...
def get_india_carbon_dioxide_change_plot_as_bytes():
    raw_e = pd.read_csv('./data/API_EN.ATM.CO2E.PC_DS2_en_csv_v2_713061.csv', skiprows=3)
    ...
    # Enable grid
    ax.grid()
    bytes_image_india = io.BytesIO()
    plt.savefig(bytes_image_india, format='png')
    bytes_image_india.seek(0)
    return bytes_image_india
...
def get_uk_carbon_dioxide_change_plot_as_bytes():
    raw_e = pd.read_csv('./data/API_EN.ATM.CO2E.PC_DS2_en_csv_v2_713061.csv', skiprows=3)
    ...
    # Enable grid
    ax.grid()
    bytes_image_uk = io.BytesIO()
    plt.savefig(bytes_image_uk, format='png')
    bytes_image_uk.seek(0)
    return bytes_image_uk
...
def get_australia_carbon_dioxide_change_plot_as_bytes():
    raw_e = pd.read_csv('./data/API_EN.ATM.CO2E.PC_DS2_en_csv_v2_713061.csv', skiprows=3)
    ...
    # Enable grid
    ax.grid()
    bytes_image_aus = io.BytesIO()
    plt.savefig(bytes_image_aus, format='png')
    bytes_image_aus.seek(0)
    return bytes_image_aus
...
def get_japan_carbon_dioxide_change_plot_as_bytes():
    raw_e = pd.read_csv('./data/API_EN.ATM.CO2E.PC_DS2_en_csv_v2_713061.csv', skiprows=3)
    ...
    # Enable grid
    ax.grid()
    bytes_image_japan = io.BytesIO()
    plt.savefig(bytes_image_japan, format='png')
    bytes_image_japan.seek(0)
    return bytes_image_japan
...
def get_germany_carbon_dioxide_change_plot_as_bytes():
    raw_e = pd.read_csv('./data/API_EN.ATM.CO2E.PC_DS2_en_csv_v2_713061.csv', skiprows=3)
    ...
    # Enable grid
    ax.grid()
    bytes_image_ger = io.BytesIO()
    plt.savefig(bytes_image_ger, format='png')
    bytes_image_ger.seek(0)
    return bytes_image_ger
...
def get_nigeria_carbon_dioxide_change_plot_as_bytes():
    raw_e = pd.read_csv('./data/API_EN.ATM.CO2E.PC_DS2_en_csv_v2_713061.csv', skiprows=3)
    ...
    # Enable grid
    ax.grid()
    bytes_image_nig = io.BytesIO()
    plt.savefig(bytes_image_nig, format='png')
    bytes_image_nig.seek(0)
    return bytes_image_nig
...
def get_brazil_carbon_dioxide_change_plot_as_bytes():
    raw_e = pd.read_csv('./data/API_EN.ATM.CO2E.PC_DS2_en_csv_v2_713061.csv', skiprows=3)
    ...
    # Enable grid
    ax.grid()
    bytes_image_brazil = io.BytesIO()
    plt.savefig(bytes_image_brazil, format='png')
    bytes_image_brazil.seek(0)
    return bytes_image_brazil
...
def get_carbon_offset_plot_as_bytes():
    ...
    bytes_carbon_offset = io.BytesIO()
    plt.savefig(bytes_carbon_offset,format='png')
    bytes_carbon_offset.seek(0)
    return bytes_carbon_offset
